...
public class Door
{
  ...
  public Door(float x, float y)
  {
    ...
    this.Door = new Rectangle(x, y, 70.0F, 90.0F);
  ...
  public Object interact(Nolan nolan)
  {
    ...
    nolan.setBedroom(false);
    nolan.setHallway(true);
    nolan.setSwitchHallway(true);
  ...
  {
    return Intersector.overlaps(nolan.getBoundingRect(), this.Door);
  }
